# Devcode Starter using Vue Level 4
...
1. Selesaikan semua TODO yang terdapat pada file `store/index.js`, `ContactManagerView.vue`, `InputContactForm.vue`, `ContactItem.vue`
